...
organizerInsertvalues = [
    ("testemail@email.com","a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3","abs","glen","lee"),
    ("testemail2@email.com","a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3","abs","john","NULL")
]
...
projDetailsInsertvalues = [
   ("ABC VOTING","DRAFT","2022-02-20","11:00","2022-02-20","11:05","abababba"),
...
electionmsgsInsertvalues = [
   (1,"Annual Promotion Slot","Thank you for voting! Your vote will be anonymous","You are invited to the annual promotion voting event","Remember to vote! Every Vote Counts!")
]
...
questionsInsertvalues = [
   (1,"Q1","Who should be promoted?"),
   (2,"Q2","Who should be the COO of the company?"),
...
candidatesInsertvalues = [
   (1, 1, "Candidate 1", "Charlie.jpg", "Experience: xxxxx years as a managerial role"),
   (1, 1, "Candidate 2", "KimNamJoon.jpg", "Head of Finance Department"),
   (2, 2, "Charlie", "Charlie.jpg", """"Experience: 13 years
                                Award: Employees' Choice Awards
                                Position: Finance director"""),

   (2, 2, "Jisoo", "Jisoo.jpg", """Experience: 10 years
